...
const config = {
  ...
  app: {
    ...
    copyright: "© 2026 DUB5. All rights reserved.",
    ...
    test_info_text:
      "Je moet alle woorden uit de woordenlijst kennen, alle grammatica-regels en alle vervoegingen van de werkwoorden haben, sein en werden.",
  },
  ...
  seo: {
    ...
    description:
      "Leer Duits op een effectieve en interactieve manier met DUB5. Woordenschat, grammatica, oefentoetsen en meer.",
    keywords:
      "Duits leren, Duitse taal, woordenschat, grammatica, taalcursus, online leren",
    author: "DUB5",
    ogImage:
      "https://images.unsplash.com/photo-1527866959252-deab85ef7d1b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
  },
